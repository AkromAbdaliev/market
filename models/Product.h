...
class Product
{
  public:
    ...
    ProductDetail getProductDetail(const drogon::orm::DbClientPtr &clientPtr) const;
    void getProductDetail(const drogon::orm::DbClientPtr &clientPtr,
                          const std::function<void(ProductDetail)> &rcb,
                          const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<std::pair<Category,ProductCategory>> getCategory(const drogon::orm::DbClientPtr &clientPtr) const;
