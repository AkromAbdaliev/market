...
class ProductDetail
{
  public:
     ...
     */
    explicit ProductDetail(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ProductDetail(const Json::Value &pJson) noexcept(false);
     ...
     */
    ProductDetail(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const std::string &getValueOfWeight() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getWeight() const noexcept;
    ///Set the value of the column weight
    void setWeight(const std::string &pWeight) noexcept;
    void setWeight(std::string &&pWeight) noexcept;
    ...
    Product getProduct(const drogon::orm::DbClientPtr &clientPtr) const;
    void getProduct(const drogon::orm::DbClientPtr &clientPtr,
                    const std::function<void(Product)> &rcb,
                    const drogon::orm::ExceptionCallback &ecb) const;
  private:
    friend drogon::orm::Mapper<ProductDetail>;
    friend drogon::orm::BaseBuilder<ProductDetail, true, true>;
    friend drogon::orm::BaseBuilder<ProductDetail, true, false>;
    friend drogon::orm::BaseBuilder<ProductDetail, false, true>;
    friend drogon::orm::BaseBuilder<ProductDetail, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ProductDetail>;
#endif
    ...
    std::shared_ptr<std::string> weight_;
    struct MetaData
    {
