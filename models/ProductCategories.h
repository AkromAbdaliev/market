...
class ProductCategories
{
  public:
    ...
    using PrimaryKeyType = std::tuple<int32_t,int32_t>;//product_id,category_id
     ...
     */
    explicit ProductCategories(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ProductCategories(const Json::Value &pJson) noexcept(false);
     ...
     */
    ProductCategories(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    ProductCategories() = default;
  ...
  private:
    friend drogon::orm::Mapper<ProductCategories>;
    friend drogon::orm::BaseBuilder<ProductCategories, true, true>;
    friend drogon::orm::BaseBuilder<ProductCategories, true, false>;
    friend drogon::orm::BaseBuilder<ProductCategories, false, true>;
    friend drogon::orm::BaseBuilder<ProductCategories, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ProductCategories>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where product_id = $1 and category_id = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where product_id = $1 and category_id = $2";
        return sql;
    }
