...
class Products
{
  public:
    struct Cols
    {
        ...
        static const std::string _detail_id;
    };
    ...
    /**  For column detail_id  */
    ///Get the value of the column detail_id, returns the default value if the column is null
    const int32_t &getValueOfDetailId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getDetailId() const noexcept;
    ///Set the value of the column detail_id
    void setDetailId(const int32_t &pDetailId) noexcept;
    void setDetailIdToNull() noexcept;
    ...
    ProductDetails getProductDetails(const drogon::orm::DbClientPtr &clientPtr) const;
    void getProductDetails(const drogon::orm::DbClientPtr &clientPtr,
                           const std::function<void(ProductDetails)> &rcb,
                           const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<std::pair<Categories,ProductCategories>> getCategories(const drogon::orm::DbClientPtr &clientPtr) const;
  ...
  private:
    ...
    std::shared_ptr<int32_t> detailId_;
    struct MetaData
    {
