...
class ProductCategory
{
  public:
     ...
     */
    explicit ProductCategory(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<ProductCategory>;
    friend drogon::orm::BaseBuilder<ProductCategory, true, true>;
    friend drogon::orm::BaseBuilder<ProductCategory, true, false>;
    friend drogon::orm::BaseBuilder<ProductCategory, false, true>;
    friend drogon::orm::BaseBuilder<ProductCategory, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ProductCategory>;
#endif
